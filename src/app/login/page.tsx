...
import { Mail, Lock, ArrowRight, Eye, EyeOff, Sparkles, Building2, AlertCircle } from 'lucide-react';
        ...
        <div className="relative overflow-hidden gradient-mesh p-8 text-white">
          ...
          <div className="relative z-10 flex flex-col items-center text-center">
            ...
            <p className="text-white/80 text-xs sm:text-sm mt-1 max-w-xs">
              Entre na sua conta para gerenciar os setores, demandas e metas da sua empresa.
            </p>
          </div>
        </div>
