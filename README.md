...
Plataforma desenvolvida para simplificar a rotina empresarial com interface moderna, responsiva para dispositivos móveis e computadores, e sincronização de dados em tempo real.
...
| Variável / Token | Hexadecimal | Uso Principal |
| :--- | :--- | :--- |
| `--brand` | `#16a34a` | Identidade visual, botões primários e sucesso |
| `--brand-dark` | `#15803d` | Estados hover e destaques profundos |
| `--surface-1` | `#0b1120` | Fundo principal da aplicação (Dark) |
| `--surface-2` | `#1e293b` | Superfície de cards, modais e containers |
| `--surface-border` | `#334155` | Bordas e divisores estruturais |
| `--accent-blue` | `#3b82f6` | Tarefas em andamento e destaques informativos |
| `--accent-red` | `#ef4444` | Alertas, prazos expirados e ações destrutivas |
